...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/workshop-john-td/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>workshop-john-td</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>workshop-john-td</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/workshop-john-td/pipeline-template-catalog.git</repositoryUrl>
              <traits>
